  ...
  return (
    <>
        ...
        <FeaturedModulesCard 
          ...
          featuredmodulesTitle="Investing fundamentals" 
          featuredmodulesDescription="Dive into investing essentials: risk assessment, portfolio diversification, 
          and fundamental analysis for achieving financial success. Dive into investing essentials: risk assessment, 
          portfolio diversification, and fundamental analysis for achieving financial success." 
